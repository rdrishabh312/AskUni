            ...
            <div className="flex-1 flex flex-col h-full min-w-0 relative bg-gradient-to-br from-[#020617] to-[#0b1221]">
                ...
                <div className="p-4 md:p-6 bg-[#020617]/95 backdrop-blur-xl border-t border-white/5 z-20 shrink-0">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="text-center mt-3 flex items-center justify-center gap-3 text-[11px] text-gray-500 font-medium">
                            <span>AI-generated content. Check details.</span>
                            {isTrial && <span className="text-primary-400 bg-primary-900/20 px-2 py-0.5 rounded-full border border-primary-500/20">{remainingMessages} free messages</span>}
                        </div>
                    </div>
                </div>
            </div>
